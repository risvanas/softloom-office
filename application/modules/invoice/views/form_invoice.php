                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="temp_inv_no" name="temp_inv_no" onchange="select_temp_details()">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div id="page-wrap">
                                <table id="items" class="table table-bordered table-hover">
                                    ...
                                    <tr class="hide_gst">
                                        ...
                                        <td class="total-value"><textarea id="flood_cess_percent" name="flood_cess_percent">1</textarea></td>
                                    </tr>
                                    <tr class="hide_gst">
                                        <td colspan="2" class="blank"></td>
                                    ...
                                    <tr class="hide_gst">
                                        ...
                                        <td class="total-value"><textarea id="flood_cess" name="flood_cess" readonly="">0.00</textarea></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="blank"></td>
