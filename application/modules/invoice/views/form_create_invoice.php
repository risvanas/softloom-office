...
<div class="row" style="padding-top:20px;">
    <div class="col-sm-12"> 
        ...
        <div class="panel panel-default">
            ...
            <form  role="form" id="form" method="post" onsubmit="ins_data();" action="<?php echo site_url('invoice/add_new_invoice'); ?>">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">Temp Invoice Addded<span class="symbol required"> </span></label>
                                            <select class="form-control" id="temp_inv_added" name="temp_inv_added" readonly>
                                                <option value="">Select</option>
                                                <option value="1" <?php if($temp_in_added == '1') { echo "selected"; } ?>>Yes</option>
                                                <option value="0" <?php if($temp_in_added == '0') { echo "selected"; } ?>>No</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">Temp Invoice Number<span class="symbol required"> </span></label>
                                            <input class="form-control" id="temp_inv_no" name="temp_inv_no" onchange="select_temp_details()" value="<?php echo $temp_inv_no ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        $query = $this->db->query("SELECT IFNULL(MAX(BOOK_NUMBER), 100)+1 AS BOOK_NUMBER FROM tbl_transaction WHERE BOOK_NAME='INVOE' and ACC_YEAR_CODE=$accounting_year and DEL_FLAG=1 and COMPANY='$company' and INVOICE_TYPE='with_tax'");
                                        $row2 = $query->row_array();
                                        $book_num = $row2['BOOK_NUMBER'];
                                        ?>
                                    ...
                                    <table id="items" class="table table-bordered table-hover">
                                        ...
                                        <?php if($invoice_type == 'with_tax') { ?>
                                            <tr class="hide_gst">
                                                ...
                                                $flood_cess_percent = ($row->FLOOD_CESS_PERCENT) ? $row->FLOOD_CESS_PERCENT : 0;
                                                ?>
