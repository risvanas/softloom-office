...
<div class="row" style="padding-top:20px;">
    <div class="col-sm-12"> 
        ...
        <div class="panel panel-default">
            ...
            <form  role="form" id="form" method="post" onsubmit="ins_data();" action="<?php echo site_url('invoice/invoice_update'); ?>">
                <div class="panel-body">
                    ...
                    foreach ($vno->result() as $row) {
                        ...
                        $temp_in_added = $row->TEMP_INVOICE_ADDED;
                        $temp_inv_no = $row->TEMP_INVOICE_ID;
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="temp_inv_added" name="temp_inv_added">
                                                <option value="">Select</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="temp_inv_no" name="temp_inv_no" onchange="select_temp_details()" value="<?php echo $temp_inv_no ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
