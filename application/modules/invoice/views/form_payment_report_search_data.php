            ...
            ?>
              <tr>
                  <?php
                    ...
                    ?>
                  <!-- <td><a href="<?php //echo site_url('invoice/print_payment_report') . encrypt($row->PAY_ID); ?> " target="_blank">PAY<?php //echo $row->PAY_NUMBER . " / " . $from_date . "-" . $to_date; ?></a></td> -->
                  <td><a href="#">PAY<?php echo $row->PAY_NUMBER . " / " . $from_date . "-" . $to_date; ?></a></td>
