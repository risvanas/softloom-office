...
<div class="row" style="padding-top:20px;">
    <div class="col-sm-12"> 
        ...
        <div class="panel panel-default">
            ...
            <form  role="form" id="form" method="post" action="<?php echo site_url('invoice/delete_data'); ?>">
                                ...
                                <div id="page-wrap">
                                    ...
                                    <table id="items" class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td class="total-value"><textarea id="flood_cess_percent" name="flood_cess_percent"><?php echo $row->FLOOD_CESS_PERCENT; ?></textarea></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="blank"></td>
