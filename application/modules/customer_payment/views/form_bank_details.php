...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input autocomplete="off" type="text" class="form-control" id="txt_cheque_no" name="txt_cheque_no" value=""/>
    </div>
</div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <select class="form-control" id="sel_tds" name="sel_tds" onchange="show_tds_amt(this)">
            <option value="">select</option>
...
<div class="col-md-6">
    <div class="form-group hide_tds_amt">
        <label class="control-label"> TDS Amount  </label>
        <input autocomplete="off" type="text" class="form-control" id="txt_tds_amt" name="txt_tds_amt"/>
    </div>
</div>
