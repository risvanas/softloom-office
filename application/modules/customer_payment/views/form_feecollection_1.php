                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group" id="h1">
                                            <label class="control-label">Fee Type<span class="symbol required"> </span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" id="subtotal" name="subtotal"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label"> SGST Percentage</label>
                                            <input autocomplete="off" type="text" class="form-control" id="sgst_percent" name="sgst_percent" value="9" disabled=""/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label"> CGST Percentage</label>
                                            <input autocomplete="off" type="text" class="form-control" id="cgst_percent" name="cgst_percent" value="9" disabled=""/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" id="sgst" name="sgst"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label"> CGST</label>
                                            <input autocomplete="off" type="text" class="form-control" id="cgst" name="cgst"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label"> Round Off <span class="symbol required"> </span> </label>
                                            <input autocomplete="off" type="text" class="form-control" id="round_off" name="round_off"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label"> Total Amount <span class="symbol required"> </span> </label>
