...
<div class="page-header">
  <div class="row">
    ...
    <form  id="form" method="post" action="<?php echo site_url('staff_ledger/details_staff');?>">
            ...
            <div class="col-md-2">
              <div class="form-group">
                <label class="control-label">  Book Number </label>
                 <?php $query=$this->db->query("SELECT IFNULL(MAX(BOOK_NUMBER), 100)+1 AS BOOK_NUMBER FROM tbl_transaction WHERE BOOK_NAME='SLA'");
					  $row=$query->row_array(); 
...
function displaydata()
{
	...
	$.ajax({ 
		...
		url:"<?php echo site_url('staff_ledger/details_staff_edit');?>",
