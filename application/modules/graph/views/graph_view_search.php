...
var development_return = [
		<?php
		foreach($dev_return->result() as $row) 
					  {
						  $val_month = $row->MONTH;
...
switch ($val_month) {
    ...
    default:
        $pr_month="no month";
            ...
            ['<?php echo $row->YEAR.'-'.$pr_month; ?>', <?php echo $row->O_SAL; ?>],
...
switch ($val_month) {
    ...
    default:
        $pr_month="no month";
						  ...
						  ?>
             ["<?php echo $row->YEAR.'-'.$pr_month; ?>", <?php echo $row->B_SAL; ?>],
    ...
    default:
		...
		<?php
		 ...
		 ?>
          ...
          {
			?>
			colors: ["#52e136", "#D12610", "#37b7f3", "#FB753B"],
		 ...
		 {
		?>
		 colors: ["#FB753B", "#D12610","#BBD749","#37b7f3"],
		   <?php
		 }
		 ?>
            xaxis: {
