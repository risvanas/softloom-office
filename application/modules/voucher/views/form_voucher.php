<div class="row">
    <div class="col-md-12"> 
        ...
        <form  method="post" name="form"  id="form" role="form" action="<?php echo site_url('voucher'); ?>" onsubmit="ins_data();">
            <div class="panel panel-default">
                <div class="panel-heading"> <i class="icon-external-link-sign"></i>&nbsp  Cash Voucher
                    <div class="panel-tools"> 
                        <a class="btn btn-xs btn-link panel-collapse collapses" href="#"></a><a class="btn btn-xs btn-link panel-expand" href="#"><i class="icon-resize-full"></i></a><a class="btn btn-xs btn-link panel-close" href="#"><i class="icon-remove"></i></a> </div>
                </div>
                <div class="panel-body">
                    ...
                    <div id="voc_num" class="successHandler alert alert-danger" style="display:none"><?php echo $errmsg = "Not found"; ?></div>
                    <h2><i class="icon-edit-sign teal"></i>&nbsp; Cash Voucher </h2>
                    <div>
                        <hr />
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                $query = $this->db->query("SELECT IFNULL(MAX(BOOK_NUMBER), 100)+1 AS BOOK_NUMBER FROM tbl_transaction WHERE BOOK_NAME='PV' and COMPANY='$company' and ACC_YEAR_CODE=$accounting_year and DEL_FLAG=1");
                                $row = $query->row_array();
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="acc_year" id="acc_year" Class="form-control" value="<?php echo $accounting_year ?>"/>
                        ...
                        <div class="col-md-2" id="btn_refresh" style="display:none;">
                            <div class="form-group">
                                ...
                                <a href="<?php echo site_url('voucher'); ?>"><button class="btn btn-dark-beige btn-block" type="button">Refresh&nbsp;<i class="icon-circle-arrow-right"></i> </button></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <span class="input-icon input-icon-right">
                                    <input autocomplete="off" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker" id="txt_voucher_date" name="txt_voucher_date" value=""/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Cash To</label>
                                <!--<div class="input-group">-->
                                <input autocomplete="off" type="text" name="txt_cash_to" id="txt_cash_to" Class="form-control">
                                <!--</div>-->
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Cash Received by</label>
                                <!--<div class="input-group">-->
                                <input autocomplete="off" type="text" name="txt_received_by" id="txt_received_by" Class="form-control">
                                <!--</div>-->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <button class="btn btn-dark-beige btn-block" type="submit" id="sub_reg" style="display: none;"> Submit <i class="icon-circle-arrow-right"></i> </button>
                        </div>
                        <div> </div>
                    </div>
                </div>
...
<form id="gen_pdf" name="gen_pdf" target="_blank" method="post" action="<?php echo site_url('voucher/select_data'); ?>">
...
<script >
    ...
    function loadData()
    {
        ...
        $.ajax({
            type: "POST",
            data: {name: $('#con').val()},
            url: "<?php echo site_url('voucher/account_list'); ?>",
...
<script>
    function displaydata()
    {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('voucher/select_data'); ?>",
            success: function (data)
            {
                $('#output1').html(data);
            }
