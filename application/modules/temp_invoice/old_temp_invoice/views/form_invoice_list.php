<div class="row" style="padding-top:20px;" >
    <div class="col-md-12"> 
        ...
        <div class="panel panel-default">
            <div class="panel-heading"> <i class="icon-external-link-sign"></i> Temporary Invoice List
            ...
            <div class="col-md-12">
                <h1>Temporary Invoice List<small></small></h1>
                <hr />
            </div>
            <div class="row">
                <div class="col-md-12">
            ...
            data:
                    {
                        calc: $('#txt_from').val(),
                        dat: $('#txt_to').val(),
                        inv_status: $('#invoice_status').val(),
                        key_words: $('#txt_key_words').val(),
                        inv_type: $('#invoice_type').val(),
                    },
            url: "<?php echo site_url('temp_invoice/mult_search'); ?>",
