                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2" id="btn_refresh" style="display:none;">
                            <div class="form-group">
                                ...
                                <a href="<?php echo site_url('receipt'); ?>"><button class="btn btn-dark-beige btn-block" type="button">Refresh&nbsp;<i class="icon-circle-arrow-right"></i> </button></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<form id="gen_pdf" name="gen_pdf" target="_blank" method="post" action="<?php echo site_url('receipt/select_data'); ?>">
...
//            generate_pdf('<?php // echo explode(" - ", $last_insert_buk_num)[1]      ?>')
//        }
