...
<div class="row">
    <div class="col-md-12" style="padding: 15px"> 
        ...
        <form id="form" method="post" action="<?php echo site_url('training_refund/fee_update') ?>">
            <div class="panel panel-default">

                <div class="panel-heading"> <i class="icon-external-link-sign"></i>&nbsp Training Refund
