            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" id="txt_amount" name="txt_amount" value="<?php echo $row->acc_name; ?>" readonly/>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="form-group" id="h1">
                                            <label class="control-label"> Name</label>
                                            <input autocomplete="off" type="text" class="form-control" id="txt_amount" name="txt_amount" value="<?php echo $row->name; ?>" readonly/>
                                        </div>
                                    </div>
                                    <?php
                                    $fee_date = $row->PAYMENT_DATE;
                                    if ($fee_date != '') {
                                        $fee_date = strtotime($fee_date);
                                        $fee_date = date('d-m-Y', $fee_date);
                                    }
                                    ?>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span class="input-icon input-icon-right">
                                                <input autocomplete="off" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker" name="txt_payment_date" id="txt_payment_date"  value="<?php echo $fee_date; ?>" readonly/>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span class="input-icon input-icon-right">
                                                <input autocomplete="off" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker" name="txt_due_date" id="txt_due_date" value="<?php echo $due_date; ?>" readonly>
                                                <i class="icon-calendar"></i> </span> </div>
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="<?php echo site_url('feecollection'); ?>" target="_blank"><button class="btn btn-dark-beige btn-block" type="button" id="sub_reg" name="sub_reg">Edit &nbsp;<i class="icon-circle-arrow-right"></i> </button></a>
                        </div>
                    </div>
                </div>
            </div>
