    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="icon-external-link-sign"></i>&nbspCash Receipt
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group"> 
                            ...
                            <input autocomplete="off" type="text" name="temp_voc_num" id="temp_voc_num" Class="form-control" value="<?php echo $book_name; ?>" readonly/>
                        </div> 
                    </div>  
                    <div class="col-md-2">
                        <div class="form-group">  
                ...
                <div class="row">   
                    ...
                    <div class="col-md-2">        
                        <a href="<?php echo site_url('receipt'); ?>" target="_blank">
