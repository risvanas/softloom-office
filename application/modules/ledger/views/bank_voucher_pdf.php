    ...
    <body>
        ...
        <div id="content">
            ...
            <table class="table">
                ...
                $cnt = 1;
                $amt = 0;
                foreach ($bank_voucher->result() as $key => $value) {
                    ?>
                    <?php if ($cnt == 1) { ?>
                        <tr>
                            <td colspan="2"></td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">Paid To. : <b><?php echo $cash_to ?></b></td>
                ...
                <tr>
                    ...
                    ?>
                    <td colspan="4" style="padding-top: 20px"><?php echo "Amount in words: &nbsp; Rupees " . ucwords($return) ?></td>
                </tr>
            </table>
