<html>
    ...
    <body>
        ...
        <div id="footer">
            ...
            <table class="table">
<!--                <tr>
                    <td colspan="5" class="bottom">Receipt</td>
        ...
        <div id="content">
            ...
            <table class="table">
                ...
                $cnt = 1;
                $amt = 0;
                foreach ($c_details->result() as $key => $value) {
                    ?>
                    <?php if ($cnt == 1) { ?>
                        <tr>
                            <td colspan="3">No. : <b><?php echo $value->BOOK_NAME . $value->BOOK_NUMBER ?></b></td>
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px solid;border-bottom: 1px solid;">Transaction Type</td>
                    ...
                    <tr>
                        <td>
                            <?php
                            $query = $this->db->query("select ACC_NAME from tbl_account where ACC_ID=" . $value->SUB_ACC);
                            $val = $query->row_array();
                            echo "<b>" . $val['ACC_NAME'];
                        ...
                        <?php if ($value->CREDIT) { ?>
                            ...
                            <?php $amt = $value->DEBIT; ?>
                        <?php } ?>
                        <td><?php echo ucfirst($value->TRANSACTION_TYPE); ?></td>
