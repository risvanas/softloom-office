...
<div class="row" style="padding-top:20px;" >
    <div class="col-md-9">
        <div class="panel panel-default">
            <div class="panel-heading"> <i class="icon-external-link-sign"></i> Follow up History
                ...
                <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <span class="input-icon input-icon-right">
                                        <input autocomplete="off" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker" name="txt_from_date" id="txt_from_date" onchange="search_data()" onblur="search_data()">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <span class="input-icon input-icon-right">
                                        <input autocomplete="off" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker" name="txt_to_date" id="txt_to_date" onchange="search_data()" onblur="search_data()" value="<?php echo date('d-m-Y') ?>">
                                        <i class="icon-calendar"></i> </span> </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="drp_college" class="form-control" id="drp_college" onchange="search_data()">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="drp_course" class="form-control" id="drp_course" onchange="search_data()">
                                <option value="">Select</option>
                                <?php
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="drp_sem" class="form-control" id="drp_sem" onchange="search_data()">
                                <option value="">Select</option>
                                <?php
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <label class="control-label">Date</label>
                    <span class="input-icon input-icon-right">
                        <input autocomplete="off" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker" name="txt_to_date" id="txt_to_date" value="<?php echo date('d-m-Y') ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input autocomplete="off" type="hidden" class="form-control" id="txt_frm" name="txt_frm" value="followup_db"/>
                                            <div class="form-group">
