			...
			?>
                ...
                <td class=""><div class="btn-group" width="90">
                    ...
                    <ul class="dropdown-menu" role="menu">
                      <?php
                ?>
                      <li><a href="#addnewfolloup" data-toggle="modal" onclick="getFollowupDetails(<?php echo $row->EN_ID;?>); enquiry_name('<?php echo $row->NAME; ?>');"> <i class="icon-pencil"></i> Add Followup </a> </li>
                      <li> <a href="<?php echo site_url('enquiry/find_enquiry_details'); ?>/<?php echo $row->EN_ID;?>"> <i class="icon-pencil"></i>Edit</a> </li>
                      <li> <a href="#static<?php echo $row->EN_ID;?>" data-toggle="modal"> <i class="icon-trash"></i> Delete </a> </li>
                    </ul>
                  </div></td>
              </tr>
                    ...
                    <select class="form-control" id="txt_status" name="txtstatus">
                      ...
                      <?php $stat_id=$row->id;
                                        foreach($Status->result() as $r) 
                                        {
									     $status_id=$r->id;
                                  ?>
                      <option value="<?php echo $status_id;?>" <?php if($status_id==$stat_id) echo "selected"; ?>><?php echo $r->status; ?></option>
                      <?php
                                         }
                                  ?>
                    </select>
