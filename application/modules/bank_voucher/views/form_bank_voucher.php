<div class="row">
    <div class="col-md-12"> 
        ...
        <form  method="post" name="form"  id="form" role="form" action="<?php echo site_url('bank_voucher'); ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                $query = $this->db->query("SELECT IFNULL(MAX(BOOK_NUMBER), 100)+1 AS BOOK_NUMBER FROM tbl_transaction WHERE BOOK_NAME='BV' and COMPANY='$company' and ACC_YEAR_CODE=$accounting_year and DEL_FLAG=1");
                                $row = $query->row_array();
                        ...
                        <div class="col-md-2" id="btn_refresh" style="display:none;">
                            <div class="form-group">
                                ...
                                <a href="<?php echo site_url('bank_voucher'); ?>"><button class="btn btn-dark-beige btn-block" type="button">Refresh&nbsp;<i class="icon-circle-arrow-right"></i> </button></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control"  id="txt_trans_type" name="txt_trans_type">
                                    <option value="">Select</option>
...
<div id="static" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false" style="display: none;">
    ...
    <div class="modal-footer">
        <button type="button" data-dismiss="modal" class="btn btn-default"> Cancel </button>
        <a id="hrefdelete" name="hrefdelete" type="button"  class="btn btn-dark-beige"> Continue </a> </div>
</div>
<!-- end: BOOTSTRAP EXTENDED MODAL--> 

<form id="gen_pdf" name="gen_pdf" target="_blank" method="post" action="<?php echo site_url('bank_voucher/select_data'); ?>">
...
<script>
    ...
    function loadData()
    {
        ...
        $.ajax({
            type: "POST",
            data: {name: $('#con').val()},
            url: "<?php echo site_url('bank_voucher/account_list'); ?>",
...
<script>
    function displaydata()
    {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('bank_voucher/select_data'); ?>",
            success: function (data)
            {
                $('#output1').html(data);
            }
...
<script src="<?php echo base_url(); ?>assets/js/form-validation/validation_bank_voucher.js"></script> 
<script>
