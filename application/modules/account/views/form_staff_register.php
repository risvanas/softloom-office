<div class="row" style="padding-top:20px;">
    <div class="col-md-12"> 
        ...
        <div class="panel panel-default">
            ...
            <form  role="form" id="form" method="post" action="<?php echo site_url('account/staff_register'); ?>" enctype='multipart/form-data'>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <label class="radio-inline">
                                                <input type="radio" name="rad_gender" value="male" id="rad_gender_male" class="square-grey" />
                                                Male </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="rad_gender" id="rad_gender_female" class="square-grey" value="female"  />
                                                Female </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" type="text" class="form-control" id="txt_username" name="txt_username" value=""/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label"> Password <span class="symbol required"></span> </label>
                                        <input autocomplete="off" type="password" class="form-control" id="txt_password" name="txt_password"  value=""/>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" type="text" class="form-control" name="staff_salary" id="staff_salary" >
                                    </div>
                                </div>
                            </div>
                        </div>
