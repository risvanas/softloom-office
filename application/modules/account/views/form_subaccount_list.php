                        ...
                        foreach ($cond->result() as $row) {
                            ...
                            <tr>
                                ...
                                <td class=""><div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li> <a href="<?php echo site_url('account/subaccount_edit'); ?>/<?php echo $row->ACC_ID; ?> "> <i class="icon-pencil"></i> Edit </a> </li>
                            ...
                            <div id="static<?php echo $row->ACC_ID; ?>" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false" style="display: none;">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a type="button"  class="btn btn-primary" href="<?php echo site_url('account/subaccount_delete'); ?>/<?php echo $row->ACC_ID; ?>"> Continue </a>
                                </div>
                            </div>
                            <!----------------------- end allert box ----------------------------> 
