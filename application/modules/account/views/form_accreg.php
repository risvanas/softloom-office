<div class="row" style="padding-top:20px;">
    <div class="col-md-12"> 
        ...
        <div class="panel panel-default">
            ...
            <form  method="post" name="form" action="<?php echo site_url('account'); ?>" id="form">
                            ...
                            <div class="row"> 
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" type="text" class="form-control" id="txt_opng_balance" name="txt_opng_balance"  value=""/>
