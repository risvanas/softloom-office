<div class="row" style="padding-top:20px;" >
    <div class="col-md-12"> 
        ...
        <div class="panel panel-default">
            <div class="panel-heading"> <i class="icon-external-link-sign"></i> Customer List
                                ...
                                <tr>
                                    ...
                                    <td class=""><div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li> <a href="<?php echo site_url('account/customer_edit') . $row->ACC_ID; ?> "> <i class="icon-pencil"></i> Edit </a> </li>
