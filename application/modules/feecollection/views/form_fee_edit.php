        ...
        <form id="form" method="post" action="<?php echo site_url('feecollection/fee_update') ?>">
            <div class="panel panel-default">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" name="txt_invoice_type" id="txt_invoice_type" value="<?php echo ucwords(str_replace('_', ' ', $row->INVOICE_TYPE)); ?>" readonly="readonly" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            $res = $query->row_array();
                                            ?>
                                            <input autocomplete="off" type="text" class="form-control" name="txt_course" id="txt_course" value="<?php echo $res['ACC_NAME']; ?>" readonly="readonly" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="form-group" id="h1">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" name="txt_stud_name" id="txt_stud_name" value="<?php echo $row->NAME; ?>" readonly="readonly" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="sel_acc_type" name="sel_bank">
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $acc->ACC_ID ?>" <?php
                                                                                                        if ($acc->ACC_ID == $bank) {
                                                                                                            echo "selected";
                                                                                                        }
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <input type="submit" id="sub_update" name="sub_update" value="Update" class="btn btn-primary btn-block" />
                    </div>
                </div>
                </div>
            </div>
