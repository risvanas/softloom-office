...
<!--                                <div class="to">INVOICE TO:</div>
                            ...
                            <!--</td>-->
                            <td id="invoice">
                                <h1><?php echo $book_num = $row->BOOK_NUMBER; ?></h1>
    ...
    <!--                                <th class="unit">UNIT PRICE</th>
        ...
        <!--                                    <td class="unit"><?php // echo $items->UNIT_COST;    ?></td>
                                    ...
                                    <td class="total"><?php $unit_total = round($price, 2); echo number_format($unit_total,2); ?></td>
                                </tr>
                                <?php
            ...
            if ($invoice_type == 'with_tax') {
                ...
                <table class="tax table" style="margin-top: 5px">
                    ...
                    <tr>
                        ...
                        <td class="total"><?php echo number_format($sgst_amt,2) ?></td>
                        <td class="total"><?php $tax_rate = $cgst_percent + $sgst_percent;
            echo $tax_rate . "%";
            ?></td>
                        <td class="total"><?php $tax_amt = $sgst_amt + $cgst_amt;
