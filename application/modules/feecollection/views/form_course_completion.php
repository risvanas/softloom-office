                ...
                <div class="panel-body" >
                    ...
                    <div class="panel-body">
                        <div class="successHandler alert alert-success <?php if ($msg == "") { ?> no-display <?php } ?>">
                            ...
                            <i class="icon-ok-sign"></i> <?php echo $msg; ?> </div>          <div class="row">
                            <div class="col-md-6">

                                <?php /* foreach($student_account->result() as $res)
                                  {
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" id="txt_course" name="txt_course" value="<?php //echo $course_name; ?>"/>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group" id="h1">
                                            ...
                                            <input type="hidden" class="form-control" id="txt_stud_name" name="txt_stud_name" value="<?php //echo $res->NAME; ?>"/>
