        ...
        <tbody>
            ...
            foreach ($res->result() as $row) {
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        $pay_date = $row->DATE_OF_TRANSACTION;
                    ...
                    <td><?php if ($row->DEBIT == "") {
                        echo "";
                    } else { ?><span class="badge badge-success"><?php echo $row->DEBIT;
            } ?></span></td>
                    <td><?php if ($row->CREDIT == "") {
                    echo "";
                } else { ?><span class="badge badge-success"><?php echo $row->CREDIT;
            } ?></span></td>
                    <td><?php if ($row->TRANS_TYPE == "") {
                    echo "";
                } else { ?><code><?php echo $row->TRANS_TYPE;
            } ?></code></td>
                    <?php
