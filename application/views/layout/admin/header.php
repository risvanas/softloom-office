<div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <!-- start: LOGO -->
            <a class="navbar-brand" href="<?php echo site_url('dashboard'); ?>" style="padding-top:2px; padding-bottom:1px;">
                <img alt="" src="<?php echo base_url(); ?>assets/images/logo.png" style="height:43px; width:auto;">
            </a>
            <!-- end: LOGO -->
        </div>
                                        ...
                                        <a href="javascript:;">
                                            <div class="clearfix">
                                                <div class="thread-image">
                                                    <img alt="" src="<?php
         echo base_url(); ?>assets/images/avatar-2.jpg">
                                                </div>
                ...
                <li class="dropdown current-user">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <span class="username"><?php echo $session_data['user_name']; ?></span>
