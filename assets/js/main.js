   ...
   //function to detect explorer browser and its version
    ...
    var runContainerHeight = function () {
        ...
        if (mainContainer.outerHeight() < mainNavigation.outerHeight()) {
            ...
            mainContainer.css('min-height', '650px');
        };
    };
    ...
    var runModuleTools = function () {
        ...
        $('.panel-tools .panel-refresh').bind('click', function (e) {
            ...
            el.block({
                ...
                message: '<img src="http://office.softloom.com/assets/images/loading.gif" /> Just a moment...',
                css: {
                    border: 'none',
                    color: '#333',
                    background: 'none'
...
//                $('.main-navigation-menu li').removeClass('active');
                ...
                $(this).parent().parent("ul").parent("li").addClass("open");
                $(this).parent().parents("li").children('ul').slideDown(200, function () {
                    runContainerHeight();
                });
                url_found = 1;
            }
